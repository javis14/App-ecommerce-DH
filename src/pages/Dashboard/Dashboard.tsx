        ...
        <div className={styles.container}>
            ...
            <form onSubmit={handleSubmit}>
                <div className={styles.formControlLogin}>
                    ...
                    <input type="text" id="amiiboSeries" name="amiiboSeries" value={product.amiiboSeries} onChange={handleChange} required />
                </div>
                <div className={styles.formControlLogin}>
                ...
                <div className={styles.formControlLogin}>
                    ...
                    <input type="text" id="gameSeries" name="gameSeries" value={product.gameSeries} onChange={handleChange} required />
                </div>
                <div className={styles.formControlLogin}>
